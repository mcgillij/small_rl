...
def new_game():
    ...
    message('Welcome stranger! Prepare to perish at the hand of Orcs and Trolls.', libtcod.red)
...
libtcod.console_init_root(SCREEN_WIDTH, SCREEN_HEIGHT, 'Rogue-Like!', False)
